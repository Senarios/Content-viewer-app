...
public class DatumFilter {
    ...
    @SerializedName("event_payments_and_verification")
    @Expose
    private List<Object> eventPaymentsAndVerification = null;
    ...
    public List<Object> getEventPaymentsAndVerification() {
        return eventPaymentsAndVerification;
    }

    public void setEventPaymentsAndVerification(List<Object> eventPaymentsAndVerification) {
        this.eventPaymentsAndVerification = eventPaymentsAndVerification;
    }
