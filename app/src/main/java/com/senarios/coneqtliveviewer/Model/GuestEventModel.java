...
public class GuestEventModel {
    ...
    @SerializedName("totalEventPurchased")
    @Expose
    private Integer totalTicketPurchased;
    @SerializedName("EventPurchasedLastHour")
    @Expose
    private Integer eventPurchasedLastHour;
    ...
    public Integer getEventPurchasedLastHour() {
        return eventPurchasedLastHour;
    }

    public void setEventPurchasedLastHour(Integer eventPurchasedLastHour) {
        this.eventPurchasedLastHour = eventPurchasedLastHour;
    }
